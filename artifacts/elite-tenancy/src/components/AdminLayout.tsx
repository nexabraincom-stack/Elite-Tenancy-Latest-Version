...
import { LayoutDashboard, Building2, UserCheck, BookOpen, Users, LogOut, ShieldCheck, User, Star, Gift, TrendingUp } from "lucide-react";
...
const navItems = [
  ...
  { label: "SEO Dashboard", href: "/admin/seo-dashboard", icon: TrendingUp },
