      ...
      <PublicLayout>
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
          ...
          <p className="text-muted-foreground text-lg">
            Thank you, {form.name}. A member of our valuation team will contact you within 24 hours to discuss your property and share your data-backed rental assessment.
          </p>
        </div>
      </PublicLayout>
    );
      ...
      <div className="bg-gradient-to-br from-card to-background border-b border-border/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          <p className="text-muted-foreground max-w-xl">
            Find out what your property could achieve on the rental market. Our team provides a detailed, data-backed assessment remotely — no in-person visit required.
          </p>
        </div>
      </div>
