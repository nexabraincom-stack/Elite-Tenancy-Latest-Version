            ...
            <div className="space-y-5">
              ...
              <div className="bg-primary/5 border border-primary/15 rounded-lg p-4 mt-6">
                ...
                <p className="text-xs text-muted-foreground">
                  Once submitted, our team will contact you within 24 hours to arrange a valuation visit and discuss your requirements. You'll only pay our £395 Introduction Only fee when a tenant successfully moves in.
                </p>
              </div>
            </div>
          )}
