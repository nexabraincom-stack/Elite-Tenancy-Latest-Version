    ...
    <PublicLayout>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        ...
        <div className="prose prose-invert prose-sm max-w-none prose-headings:font-serif prose-headings:text-foreground prose-p:text-muted-foreground prose-p:leading-relaxed prose-h2:text-xl prose-h2:mt-8 prose-h2:mb-3 prose-li:text-muted-foreground">
          ...
          <h2>2. Services</h2>
          <p>Elite Tenancy Ltd provides a tenant introduction and property management service. Our Introduction Only service connects landlords with pre-qualified tenants. Our Premium Managed service additionally provides ongoing property management. Our fee for Introduction Only is £395 per successful tenancy commencement. Our Premium Managed fee is 8% of monthly rent collected.</p>
